...
"""
setup module for alibabacloud_openitag.
...
PACKAGE = "openitag_sdk"
NAME = "alibabacloud_openitag" or "alibabacloud-package"
...
REQUIRES = [
    ...
    "alibabacloud_openitag20220616>=1.0.1, <2.0.0",
    "darabonba_rsa>=0.0.7, <1.0.0"
]
...
setup(
    ...
    url=URL,
    keywords=["alibabacloud","openitag"],
